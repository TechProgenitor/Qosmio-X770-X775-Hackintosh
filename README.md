...
| USB | NEC/Renesas uPD720200<br>Intel 6 Series/C200 Series Chipset |
| WiFi/BT | Qualcomm Atheros AR9285/AR3011<br>Broadcom BCM4352/BCM20702A0 |
| LAN | Realtek RTL8111 |
...
| [Disable ringFreqTables](https://www.insanelymac.com/forum/topic/359901-no-cfg-lock-option-in-bios/#comment-2824861) kernel patch doesn't work above macOS Sierra or on macOS installers. | Either need to tweak the config.plist file or write a Lilu plugin. |
...
| Boot picker cursor responsiveness is choppy on cold boot. | I’m not sure what’s causing this issue. If you want to hide the cursor, you can do so by opening the config.plist and setting the "PickerAttributes" value to 0. |